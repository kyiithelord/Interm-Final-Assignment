...
class AccountTaxInherited(models.Model):
    ...
    def compute_all(self, price_unit, currency=None, quantity=1.0, product=None, partner=None, is_refund=False, handle_price_include=True, include_caba_tags=False, fixed_multiplicator=1, discount_amount=0.0):
    ...
    def _convert_to_tax_base_line_dict(
            ...
            extra_context=None,discount_amount=None,
    ):
        return {
            'record': base_line,
    ...
    def _compute_taxes_for_single_line(self, base_line, handle_price_include=True, include_caba_tags=False, early_pay_discount_computation=None, early_pay_discount_percentage=None):
        ...
        if taxes:
            ...
            price_subtotal = currency.round((price_unit_after_discount * base_line['quantity']) - base_line['discount_amount'])
            to_update_vals = {
